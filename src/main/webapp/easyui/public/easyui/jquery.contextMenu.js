                    ...
                    $(this).mouseup(function (e) {
                        ...
                        if (evt.button == 2) {
                            ...
                            $('#' + o.menu).find('>li:not(.ui-state-disabled)').click(function () {
                                ...
                                $(".cleverContextMenu").hide();
                                var _action = $(this).find('>a:first').attr('href');
                                // Callback
                                if (callback) callback(_action.substr(_action.lastIndexOf("#")+1), $(srcElement), { x: x - offset.left, y: y - offset.top, docX: x, docY: y }, $(tarElement));
                                return false;
                            });
