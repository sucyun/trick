package com.trick.web.core.shiro.manager.impl;

import com.trick.web.common.utils.Log.LoggerUtils;
import com.trick.web.core.config.INI4j;
import com.trick.web.core.shiro.manager.ShiroManager;
...
public class ShiroManagerImpl implements ShiroManager {
	...
	private String getFixedAuthRule() {
		...
		try {
			...
			System.out.println("-----");
			System.out.println("-----");
			System.out.println("-----"+ini==null?"ini为空++++++++++++++++++":ini.get("base_auth"));
			System.out.println("-----");
			System.out.println("-----");
			System.out.println("-----");
		} catch (IOException e) {
