package com.trick.biz.utils.core;
 ...
 * @see -------------------------------------------------------------------------------------------------------------- 
 * @see 另外,给Shiro加入验证码有多种方式,也可以�?�过继承修改FormAuthenticationFilter�?,通过Shiro去验证验证码 
 * @see 而这里既然使用了SpringMVC,也为了简化操�?,就使用此工具生成验证�?,并在Controller中处理验证码的校�? 
 * @see -------------------------------------------------------------------------------------------------------------- 
...
public class VerifyCodeUtil {
	 ...
	 * 生成图片验证�?
	 * 
	 * @param type 验证码类�?,参见本类的静态属�?
	 * @param length 验证码字符长�?,要求大于0的整�?
	 * @param excludeString �?排除的特殊字�?
	 * @param width 图片宽度(注意此宽度若过小,容易造成验证码文本显示不�?,�?4个字符的文本可使�?85�?90的宽�?)
	 * @param height 图片高度
	 * @param interLine 图片中干扰线的条�?
	 * @param randomLocation 每个字符的高低位置是否随�?
	 * @param backColor 图片颜色,若为null则表示采用随机颜�?
	 * @param foreColor 字体颜色,若为null则表示采用随机颜�?
	 * @param lineColor  干扰线颜�?,若为null则表示采用随机颜�?
	 * @return 图片缓存对象
	 */
	 ...
	 * 
	 * @param type 验证码类�?,参见本类的静态属�?
	 * @param length 验证码长�?,要求大于0的整�?
	 * @param excludeString �?排除的特殊字符（无需排除则为null�?
	 * @return 验证码字符串
	 */
	 ...
	 *            文本验证�?
	 * @param width
	 *            图片宽度(注意此宽度若过小,容易造成验证码文本显示不�?,�?4个字符的文本可使�?85�?90的宽�?)
	 * @param height
	 *            图片高度
	 * @param interLine
	 *            图片中干扰线的条�?
